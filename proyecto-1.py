...
def jugarContracomputador():
    ...
    tableroDisparosComputador=crearTablero(tamano)
    ...
    while True:
        if turnoJugador:
            print("Tu turno")
            mostrarTableros(tableroDisparosJugador,tableroDisparosComputador)
         ...
         resultado=realizarDisparo(tableroDisparosJugador,tableroDisparosComputador,fila,columna)
...
def mostrarMenu():
    print("Bienvenido al juego Batlla Naval")
...
def iniciarJuego():
    while True:
        ...
        if modo == "1":
            ...
            print("la opcion seleccionada no es valida, elige una numero del 1 al 3")
            continue
